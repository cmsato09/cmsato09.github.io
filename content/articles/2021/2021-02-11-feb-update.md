...
modified: 2021-02-11
category: learning
tags: matplotlib, pyplot, data and algorithms, django, leetcode, database
slug: feb-update
author: cmsato09
status: published
---
...
I didn't understand what "Big-O notation" was until reading on data structures and algorithms. I watched the first lesson of [MIT opencourseware course 6.006 Intro to Algorithms](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-006-introduction-to-algorithms-fall-2011/) and I understood most of it, but it did take a couple of rewinds to understand some parts. I didn't think I was ready for the course so I began reading [Problem Solving with Algorithms and Data Structures using Python](https://runestone.academy/runestone/books/published/pythonds/index.html) by Brad Miller and David Ranum. So far, I've gotten to stacks section. 
